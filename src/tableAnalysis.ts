 ...
 */
export async function analyzeDatabaseTables(
  tableNames: string[],
  detailLevel: string,
  database?: string
...
async function fetchBasicColumnDetails(dbName: string, tableName: string): Promise<any[]> {
...
async function fetchFullColumnDetails(dbName: string, tableName: string): Promise<any[]> {
...
async function fetchForeignKeyDetails(dbName: string, tableName: string): Promise<any[]> {
...
async function fetchBasicIndexDetails(dbName: string, tableName: string): Promise<any[]> {
...
async function fetchFullIndexDetails(dbName: string, tableName: string): Promise<any[]> {
